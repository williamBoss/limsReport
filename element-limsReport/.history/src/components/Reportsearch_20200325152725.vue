  ...
  <div id="reportSearchContainer">
    <el-form ref="form">
      <el-form-item label="订单编号:">
        <el-input placeholder="请输入订单编号" clearable size="small" v-model="searchQuery.orderCode"/>
      </el-form-item>
      <el-form-item label="检测项目:">
        <el-input placeholder="请输入检测项目" clearable size="small" v-model="searchQuery.goodsName"/>
      </el-form-item>
      <el-form-item label="患者姓名:">
        <el-input placeholder="请输入患者姓名" clearable size="small" v-model="searchQuery.patientName"/>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.$axios
        .get("/api/experiment/order/list", { params: { identification: "DFP" } })
        .then(res => {
