...
import com.lims.framework.security.handle.AuthenticationEntryPointImpl;
import com.lims.framework.security.handle.LogoutSuccessHandlerImpl;
import com.lims.framework.security.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
            ...
            .anonymous().antMatchers("/experiment/user/login").anonymous().antMatchers("/experiment/order/orderList")
            .anonymous().antMatchers("/upload/file/addUploadFile").anonymous().antMatchers("/test/**").anonymous()
            // 除上面外的所有请求全部需要鉴权认证
